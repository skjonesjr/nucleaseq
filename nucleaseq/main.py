...
Usage:
  nucleaseq preprocess <uncut_or_cut> <targets_file> <target_name> <pamtarg_pos> <exploded_oligos_file> <read_names_by_seq_file> <read_names_by_sample_file> [--start=<start>] [--inc=<inc>] [-v | -vv | -vvv]
