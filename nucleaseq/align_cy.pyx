...
cdef dict BLOSUM62 = {letter: dict(zip(_AA_LETTERS, scores))
            for letter, scores in _BLOSUM62_SCORES.items()}


cdef dict METHODS = {"global": 0, "local": 1, "glocal": 2, "global_cfe": 3}
...
cpdef aligner(seqj, seqi, method='global', gap_open=-7, gap_extend=-7,
